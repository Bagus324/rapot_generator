...
if (isset($_POST['submit'])) {
    // var_dump($_POST);
    $output = tambah_guru($_POST);

    if ($output > 0) {
        echo "<script> alert('Data guru berhasil ditambah')
            window.location = 'guru.php';
            </script>";
    } else {
        echo "<script> alert('Data guru gagal ditambah')</script>";
    }
}
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <p style="font-size: 20px;font-weight:bold;">Firqoh Guru</p>
                            <select id="id_kelas" name="id_kelas" class="form-control col-sm-3">

                                <?php foreach ($data_kelas as $row) {
                                    if (!in_array($row['id_kelas'], $new_data_kelas)) {
