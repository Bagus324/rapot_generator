...
?>
                ...
                <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <select id="id_siswa" name="id_siswa">
                            <?php foreach ($data_siswa as $row) : ?>
                                <?php if ($row['id_siswa'] == $id_siswa): ?>
                                    <option value="<?= $row['id_siswa']; ?>" selected><?= ucfirst($row['nama']) ?></option>
                                <?php else:?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-user" id="nis" name="bindo" style="width: 500px;" value="<?= $row['bindo']; ?>" required></input>
                    </div>
                    <div class="form-group">
                        <p style="font-size: 20px;font-weight:bold;">Nilai Sejarah Islam</p>
                        <input type="text" class="form-control form-control-user" id="nis" name="sej_islam" style="width: 500px;" value="<?= $row['sej_islam']; ?>" required></input>
                    </div>
                    <div class="form-group">
                        <p style="font-size: 20px;font-weight:bold;">Nilai Baca-Tulis Al-Qur'an</p>
                        <input type="text" class="form-control form-control-user" id="nis" name="btq" style="width: 500px;" value="<?= $row['btq']; ?>" required></input>
                    </div>
