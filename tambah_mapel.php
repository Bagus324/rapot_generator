...
if (isset($_POST['submit'])) {
    // var_dump($_POST);
        $output = tambah_mapel($_POST);

        if ($output > 0) {
            echo "<script> alert('Data Mapel berhasil ditambah')
            window.location = 'mapel.php';
            </script>";
        } else {
            echo "<script> alert('Data Mapel gagal ditambah')</script>";
        }
}
...
?>
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <p style="font-size: 20px; font-weight:bold;">Nama Mata Pelajaran</p>
