...
$nama = $_SESSION['nama'];
$validifier = querydb("SELECT * FROM user WHERE id_user = 3")[0];
if (isset($_POST['submit'])) {
    // var_dump($_POST);
    if ($_POST['pw_lama'] == $validifier['password']) {
        $_POST['id'] = $id_user;
        $output = ganti_pw($_POST);
...
?>
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <p style="font-size: 20px; font-weight:bold;">Password Lama</p>
                        <input type="password" class="form-control form-control-user" id="nama" name="pw_lama" style="width: 500px;" required></input>
                    </div>
                    <div class="form-group">
