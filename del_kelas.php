...
if (isset($_POST['submit'])) {
    ...
    if ($output > 0) {
        ...
        echo "<script> alert('Terdapat kesalahan, Data Kelas gagal dihapus')</script>";
    }
}
                ...
                <div class="container-fluid">
                    ...
                    <form action="" method="post">
                        <?php foreach ($data_kelas as $row) : ?>
                            ...
                            <input class="form-control col-sm-3" type="text" value="<?= $row['nama_kelas']; ?>" name="nama_kelas" readonly>
